...
SWIFT_CLASS("_TtC15CoreDataHitList11AppDelegate")
...
SWIFT_CLASS("_TtC15CoreDataHitList14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(CoreDataHitList))
- (void)savePersonWithName:(NSString * _Nonnull)name;
@end

@class NSIndexPath;
@class UITableViewCell;

@interface ViewController (SWIFT_EXTENSION(CoreDataHitList)) <UITableViewDataSource>
